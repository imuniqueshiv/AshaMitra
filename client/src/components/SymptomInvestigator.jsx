  ...
  const handleRegistration = (e) => {
    ...
    if (demographics.age && demographics.gender && demographics.height && demographics.weight) {
      ...
      const startText = language === "en" 
        ? `Hello. I am AshaMitra. I noted your BMI is ${bmiResult.value} (${bmiResult.category}). What symptoms are you experiencing?`
        : `नमस्ते। मैं डॉ. आशामित्र हूँ। आपका बीएमआई ${bmiResult.value} (${bmiResult.category}) है। आपके लक्षण क्या हैं?`;
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-black text-white">
              AshaMitra ({demographics.age}/{demographics.gender.charAt(0)})
            </h3>
        ...
        {history.map((msg, idx) => (
          ...
          >
            <span className="text-[10px] text-white/20 uppercase tracking-widest font-bold mb-1 px-1">
              {msg.role === "user" ? "You" : "AshaMitra AI"}
            </span>
